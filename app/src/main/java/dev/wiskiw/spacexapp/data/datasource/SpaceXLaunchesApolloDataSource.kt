...
class SpaceXLaunchesApolloDataSource(
    private val apolloClient: ApolloClient,
    private val logger: AppLogger,
) : SpaceXLaunchesRemoteDataSource {
    ...
    override suspend fun getLaunchList(): List<LaunchDetailsShort> {
    ...
    @Throws(DataSourceException::class)
    override suspend fun getLaunch(id: String): LaunchDetailsFull {
